...
> Your Personal Workspace is ideal for your own projects that are NOT shared across a team or an organization. If you wish to continue with the Personal Workspace you can skip this section and [start configuring a Project](./03-projects.md) in your personal workspace.
...
[Read about these concepts](./01-resource-hierachies.md)
...
2. From the Admin Panel select **Create an Organization**
